 ...
 *
 * Ported from UV-K1Series_ApeX-Edition (App/app/waterfall.c) into F4HWN-Fork as
 * part of the spectrum-analyzer waterfall feature; includes were converted to
 * the local ../ style to match spectrum.c's dependency layout.
 */

#include "waterfall.h"
#include "../driver/st7565.h"  /* gFrameBuffer */
#include "../misc.h"   /* dBmCorrTable */
#include "../radio.h"  /* gRxVfo */
#include <string.h>
